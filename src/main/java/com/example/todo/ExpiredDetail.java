 ...
 */
public class ExpiredDetail extends Fragment {

    TextView subject, date, description, remaining_days, title;
    ImageView back_img;
    Expired_Model expiredModel;
    Bundle bundle;

    public ExpiredDetail() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_expired_detail, container, false);
