...
import com.example.todo.CompletedFragment.Complete_Model;


/**
 * A simple {@link Fragment} subclass.
 */
public class CompletedDetail extends Fragment {

    TextView subject,date,description,remaining_days,title;
    ImageView back_img;

    public CompletedDetail() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_completed_detail, container, false);
    ...
    private void init(View view) {
        ...
        title.setText("Complete Details");
