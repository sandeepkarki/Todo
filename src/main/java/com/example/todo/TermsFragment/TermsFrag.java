package com.example.todo.TermsFragment;
...
public class TermsFrag extends Fragment {
    ...
    private void hitUrlforData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, constant.TERM_API, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {

                Log.d("TermResponse", response);
                progressBar.hide();
    ...
    private void init(View view) {
        ...
        txt_desc=view.findViewById(R.id.txt_terms);
